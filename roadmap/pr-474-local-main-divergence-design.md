...
- The metadata hook fails closed for chained guarded `gh pr create` / `gh pr merge` commands, including command substitution forms that can hide the guarded command.
