...
| Multi-PR triage | **`babysit/SKILL.md`** (`/babysit`) — survey all open PRs, classify, spawn parallel AO workers |
...
Legacy loose `*.md` copies were removed from this directory to avoid drift; use the paths above.
