...
- **Binary installation norms: `AGENTS.md` — "AO Binary Installation — Non-Negotiable Norm"** — `scripts/setup.sh` for repo maintainers, `npm install -g @jleechanorg/ao-cli` for others; `ao doctor` must pass after any install or update
