...
- **Binary installation norms: `AGENTS.md` — "Binary Installation — Canonical Install Paths"** — `scripts/setup.sh` for repo maintainers, `npm install -g @jleechanorg/ao-cli` for others; `ao doctor` must pass after any install or update
