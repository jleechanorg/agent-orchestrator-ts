...
function extractDescription(body) {
  ...
  // Strip HTML comment blocks (e.g. CURSOR_SUMMARY injected by bots) before extracting
...
---
` : ""}
_Generated by \`scripts/generate-pr-design-docs.mjs\` · [View PR #${pr.number} on GitHub](https://github.com/${REPO}/pull/${pr.number})_
`;
}
