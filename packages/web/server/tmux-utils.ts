 ...
 * @param execFn - Injectable execFileSync for testing. Defaults to child_process.execFileSync.
 * @param fs - Injectable filesystem adapter for testing. Defaults to real filesystem.
 * @param projectId - Optional project ID to prioritize when multiple storageKeys match.
