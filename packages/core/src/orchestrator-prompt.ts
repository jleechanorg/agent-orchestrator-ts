...
5. When approved + green: notify human to merge (unless auto-merge is configured: set \`autoMerge: true\` globally or per-project, OR set the \`approved-and-green\` reaction to \`action: auto-merge\`)
