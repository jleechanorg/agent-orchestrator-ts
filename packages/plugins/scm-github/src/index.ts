...
// AO-managed runtime filenames. Kept in sync with workspace-worktree's
// AO_MANAGED_EXCLUDE_PATTERNS. These files are written by AO at session
// startup and are expected to differ from committed versions.
