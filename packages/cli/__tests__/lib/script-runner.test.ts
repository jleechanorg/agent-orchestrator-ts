...
describe("script-runner", () => {
  ...
  it("accepts a valid AO_REPO_ROOT override for source checkouts", () => {
    ...
    writeFileSync(
      ...
      JSON.stringify({ name: "@jleechanorg/ao" }),
    );
