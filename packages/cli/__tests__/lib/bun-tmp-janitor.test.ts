...
import type * as AoCore from "@jleechanorg/ao-core";
...
// @jleechanorg/ao-core's getOpenCodeTmpDir.
let mockedDir = "";
vi.mock("@jleechanorg/ao-core", async () => {
  const actual = await vi.importActual<typeof AoCore>("@jleechanorg/ao-core");
  return {
    ...actual,
