...
export function buildSkepticPrompt(
  ...
  return [
    ...
    "OR",
    "VERDICT: SKIPPED — [reason, e.g. 'infrastructure failure — cannot evaluate']",
    "",
    "IMPORTANT — use SKIPPED for infrastructure failures (e.g. 'Codex evaluation failed',",
    "'Command failed', model API error): these are not PR gaps. Output VERDICT: SKIPPED",
    "instead of FAIL when you cannot complete the evaluation due to tooling/API issues.",
    "",
