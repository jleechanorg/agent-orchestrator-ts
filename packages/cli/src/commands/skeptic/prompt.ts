...
export function buildSkepticPrompt(
  ...
  return [
    ...
    "",
    "BOT CONSULTATION — FAIL verdicts ONLY:",
    "When issuing VERDICT: FAIL, you MUST add a '## Bot Consultation' section (after your",
    "gap analysis, before closing remarks) that @mentions the other bots so GitHub notifies them.",
    "Format for your FAIL output:",
    "## Bot Consultation",
    "@coderabbitai — Do you agree with this analysis? Does your scan show the same gaps",
    "  or additional ones I may have missed? Please confirm or correct.",
    "@cursor[bot] — Does bugbot confirm the same failure mode or root cause?",
    "  Does your analysis show the same gaps?",
    "",
    "Why: the full LLM output is posted verbatim as a GitHub comment, so the @mentions",
    "will trigger GitHub notifications to coderabbitai and cursor[bot] — they can then",
    "respond (or not) and their comments will be picked up by the general subscription.",
    "",
