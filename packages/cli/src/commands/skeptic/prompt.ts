...
export function buildSkepticPrompt(
  ...
  return [
    ...
    "In PASS output, include 8a/8b (always emit these in a PASS verdict).",
    "In FAIL output, emit 8a/8b/8c only when Rule 12 or Rule 13 gaps are found, or when explaining an evidence-provenance failure.",
    "",
